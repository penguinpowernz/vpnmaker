...
== Contributing
  ...
  git clone git@github.com:penguinpowernz/vpnmaker.git # clone it
  bundle install                                       # install dependencies
  bundle exec rake c                                   # start a pry console with VPNMaker loaded
  rake test                                            # run the tests
  rake build                                           # build the gem (dumps into pkg)
